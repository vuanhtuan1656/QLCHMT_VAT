...
Public Class BaoCaoHoaDonB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyCuaHangMT.BaoCaoHoaDonB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBaoCaoHoaDonB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BaoCaoHoaDonB = New BaoCaoHoaDonB()
        rpt.Site = Me.Site
        Return rpt
    End Function
